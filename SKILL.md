...
description: Use when changing the stable Python EvoZeus OfficialFactor contract, official Factor spec schema, or official factors.
---
...
- official factors and test vectors.
...
3. Update official factors under `factors/<factor-slug>/`.
4. Run `python3 -m unittest discover -s tests`.
5. Run `python3 scripts/validate_official_factor_spec.py factors/*/spec.json`.
